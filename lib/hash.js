...
var LibHash = function () {
    // ported from 'node-opensubtitles-api' @ka2er (GPL)
};

LibHash.prototype.computeHash = function (cb, path) {
    ...
    function checksumReady(checksum_part, name) {
        ...
        if (array_checksum.length == 3) {
            ...
            cb(null, self.padLeft(checksum, '0', 16));
        }
    }
